<main>
    ...
    --invalid -->
      ...
      <div class="<?php if(isset($error['email'])){echo "form__item--invalid";}else{echo "form__item";} ?>"> <!-- form__item--invalid -->
      ...
      <div class="<?php if(isset($error['password'])){echo "form__item--invalid";}else{echo "form__item";} ?>">
      ...
      <div class="<?php if(isset($error['name'])){echo "form__item--invalid";}else{echo "form__item";} ?>">
      ...
      <div class="<?php if(isset($error['message'])){echo "form__item--invalid";}else{echo "form__item";} ?>">
